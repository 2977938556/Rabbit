                ...
                <RouterLink to="/">
                    ...
                    <div class="meta">
                        <p class="title">
                            ...
                            <span class="sub ellipsis">{{ item.updateTime }}</span>
                        </p>
                        <span class="price">&yen;19.99起</span>
                    </div>
                </RouterLink>
                <div class="foot">
                    <span class="like"><i class="iconfont icon-hart1"></i>{{ item.viewNum }}</span>
                    <span class="view"><i class="iconfont icon-see"></i>{{ item.collectNum }}</span>
                    <span class="reply"><i class="iconfont icon-message"></i>{{ item.lowestPrice }}</span>
                </div>
            </div>
        </div>
    </HomePanel>
...
export default {
    ...
    setup() {
        ...
        let { result, target } = Datalazyloading(findSpecial);
